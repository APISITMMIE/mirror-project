...
<head>
    <title>โพสต์ข้อความ | Smart Mirror - C11 Team</title>
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">รายการโพสต์</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">หน้าหลัก</a></li>
                                    <li class="breadcrumb-item active">รายการโพสต์</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <h5 class="card-title">รายการโพสต์ <span class="text-muted fw-normal ms-2">(จำนวน)</span></h5>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                            <div>
                                <!-- Button trigger modal for adding a post -->
                                <button type="button" class="btn btn-light" onclick="openAddPostModal()">
    <i class="bx bx-plus me-1"></i> เพิ่มโพสต์ใหม่
</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="editPostForm">
                    ...
                    <div class="form-group">
                        <label for="edit_header">หัวข้อ</label>
                    ...
                    <div class="form-group">
                        <label for="edit_create_by">ผู้เขียน</label>
...
ClassicEditor
    ...
    var postTable = $('.datatable').DataTable({
        ...
        "ajax": {
            "url": "api_posts.php?action=fetch",
...
$(document).on('click', '.editBtn', function() {
    ...
    $.getJSON('api_posts.php?action=getPost&id=' + postId, function(data) {
        // Populate data in the edit modal
        $('#edit_id').val(data.id);
        $('#edit_header').val(data.header);
        $('#edit_create_by').val(data.create_by);
...
$('#editPostBtn').click(function() {
    ...
    editEditor.then(editor => {
        ...
        $.post('api_posts.php?action=update', {
            id: $('#edit_id').val(),
...
$(document).on('click', '.deleteBtn', function() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: 'api_posts.php?action=delete',
                type: 'POST',
                data: { id: postId },
                dataType: 'json',
                success: function(response) {
